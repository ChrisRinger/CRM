        ...
        methods: {
            ...
            detectBrowser: function () {
                if (navigator.mozGetUserMedia) {
                    ...
                    this.createIceServerFirefox();

                    // Attach a media stream to an element.
                    this.attachMediaStreamFirefox();

                    this.reattachMediaStreamFirefox();
                    ...
                    // Attach a media stream to an element.
                    this.attachMediaStreamChrome();

                    this.reattachMediaStreamChrome();

                } else {
                    console.log("Browser does not appear to be WebRTC-capable");
                }
            },
            createIceServerFirefox: function (url, username, password) {
                var iceServer = null;
                ...
                if (url_parts[0].indexOf('stun') === 0) {
                    ...
                    if (this.webrtcDetectedVersion < 27) {
            ...
            attachMediaStreamFirefox: function (element, stream) {
                console.log("Attaching media stream");
                element.mozSrcObject = stream;
                element.play();
            },
            reattachMediaStreamFirefox: function (to, from) {
                console.log("Reattaching media stream");
                to.mozSrcObject = from.mozSrcObject;
                to.play();
            },

            createIceServerChrome: function (url, username, password) {
                var iceServer = null;
                var url_parts = url.split(':');
                if (url_parts[0].indexOf('stun') === 0) {
                    // Create iceServer with stun url.
            ...
            attachMediaStreamChrome: function (element, stream) {
            ...
            reattachMediaStreamChrome: function (to, from) {
                to.src = from.src;
            },
            /////////////////////////////////////////////
...
//                {'iceServers': [{'urls': 'stun:stun.l.google.com:19302'}]};
            ...
            var sdpConstraints = this.webrtcDetectedBrowser === 'firefox' ?
            ...
            // Call getUserMedia()
            navigator.getUserMedia(constraints, this.handleUserMedia, this.handleUserMediaError);
